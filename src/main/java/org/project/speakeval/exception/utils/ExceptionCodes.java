...
public enum ExceptionCodes implements ExceptionKeyAndMessage {
    ...
    FILE_IS_MISSED("1005", "The requested file could not be found"),
    ACCESS_DENIED_EXCEPTION("1006", "You do not have permission to perform this operation"),
    UNKNOWN_EXCEPTION("1007", "An unexpected error occurred. Please try again later");
